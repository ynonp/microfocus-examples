...
module.exports = function( grunt ) {
    ...
    grunt.initConfig({
            ...
            eslint: {
              target: ['Gruntfile.js', 'app/**/*.js', 'test/specs/**/*.js'],
            },
            uglify: {
                options: {
...
// Loading plugin(s)
    ...
    grunt.registerTask('default', ['eslint', 'connect:dev:livereload', 'open:dev', 'watch:dev']);
    grunt.registerTask('build', ['eslint', 'clean', 'copy', 'durandal:main', 'uglify', 'connect:build', 'open:build', 'watch:build']);
